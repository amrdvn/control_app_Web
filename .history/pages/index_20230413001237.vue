...
export default {
  ...
  methods: {
    async submit() {
      ...
      messaging.getToken({ vapidKey: 'BFMVehN9w9lkv0fmUmgZjNBivQuzD7rCc19-_grigV3CQ5nxFoOautPwQv0sebpeSBvd_2VJAGKnnBPY-Pv5Qp8' }).then((currentToken) => {
          ...
          messaging.getToken().then((newToken) => {
            ...
            fetch('https://fcm.googleapis.com/fcm/send', {
              ...
              headers: {
                ...
                'Authorization': 'BFMVehN9w9lkv0fmUmgZjNBivQuzD7rCc19-_grigV3CQ5nxFoOautPwQv0sebpeSBvd_2VJAGKnnBPY-Pv5Qp8'
              },
              body: JSON.stringify({
                to: token,
                notification: {
