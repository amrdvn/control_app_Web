  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div slot="emoji-picker" slot-scope="{ emojis }">
        <div class="absolute z-10 border w-64 h-96 overflow-scroll p-4 rounded bg-white shadow t-4 -r-64">
          <div class="flex">
            <input class="rounded-full border py-2 px-4 outline-none focus:shadow-outline w-full" type="text" v-model="search" v-focus>
          </div>
          <div>
