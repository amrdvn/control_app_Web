  ...
  data(){
    ...
    methods:{
      ...
      async submit(){
        ...
        const config = {
          headers: {
            'Authorization': 'Bearer AAAAMGjPLwc:APA91bEDUIb73L_y_kT8DLkj-GIxsEh7dG6ckZliLKYrmVKMaQezLZHEIoUUURFZgUWrqNvlY9edrUutcTv3zzgiqz-xo1M3XC2kYcoBFkwSlrV9uyKb5etGnLZP3h3Lg5tYosCFinpD',
            'Content-Type': 'application/json'
          }
        };
        try {
          const response = await axios.post('https://fcm.googleapis.com/fcm/send', message, config);
          // eslint-disable-next-line no-console
