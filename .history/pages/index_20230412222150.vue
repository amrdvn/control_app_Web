...
export default {
  ...
  methods: {
    submit() {
      ...
      const serviceAccount = require('../plugins/control-app-a014e-firebase-adminsdk-2mmmm-a3ffca7c6e.json');

      admin.initializeApp({
        credential: admin.credential.cert(serviceAccount)
      });

      // Get the notification data from the form
      ...
      // Send the message to the recipient device
