  ...
  methods: {
    ...
    mapYukle() {
      this.map = new google.maps.Map(document.getElementById("map"), {
        center: { lat: this.markers.length > 0 ? this.markers[0].getPosition().lat() : 41.0174, lng: this.markers.length > 0 ? this.markers[0].getPosition().lng() : 28.9883 },
        zoom: 8,
      });
    },
  },
